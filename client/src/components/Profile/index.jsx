function Profile() {
    return <main><section id="contact" className="relative z-10 bg-gradient-to-b from-black via-black/80 to-black pt-32 backdrop-blur-3xl lg:pb-32 lg:pt-0">
                    ...
                    <div className="grid gap-6 border-t border-white/30 pt-24 lg:grid-cols-3 lg:gap-24">
                        ...
                        <div >
                                ...
                                <ul className="relative z-20 mt-4 space-y-2 font-light text-white">
                                    <li>
                                        <a href="" target="_blank">Pizza Planet</a>
                                    </li>
                                    <li>
