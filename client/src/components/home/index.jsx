...
import Auth from '../../utils/auth'; // Import your Auth service
            ...
            <section id="home" className="relative flex min-h-screen items-center">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 pb-40 pt-60 lg:px-12 xl:px-6 2xl:px-0">
                    <div className="pb-12 media-h:md:pb-32 media-h:lg:pb-12 xl:pb-12">
                        <h1 data-rellax-speed="-3" data-rellax-xs-speed="0" data-rellax-mobile-speed="0" className="rellax text-6xl font-bold text-white sm:text-8xl md:text-9xl xl:leading-tight">Local Restaurants</h1>
                    </div>
                    <div>
